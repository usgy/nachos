...
Semaphore emptyBuffers((char *)"empty",BUFF_SIZE);
Semaphore fullBuffers((char *)"full",0); //two semaphores for empty and full slots
Semaphore mutex((char *)"mutex",1);          //semaphore for the mutual exclusion
